  ...
  return (
    ...
    >
                ...
                filteredMembers
                  ...
                  .map((member) => (
                    <button
                      ...
                      className="w-full p-3 hover:bg-accent flex items-center gap-3 text-left transition-colors border-b border-border last:border-0"
                    >
                      <Image
                        src={member.avatar}
                        alt={member.name}
                      ...
                      <Circle
                        className={`w-2 h-2 rounded-full ${
                          getOnlineStatus(member.uid) === "online"
                            ? "bg-green-500"
                            : "bg-gray-400"
                        }`}
                        fill="currentColor"
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Individual Members (Only those with active conversations) */}
        {viewMode === "active" && (
          <>
            {chatGroups.length > 0 && (
              <div className="px-4 py-2 text-xs font-semibold text-muted-foreground uppercase">
