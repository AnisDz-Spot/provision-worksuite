...
export function GanttChart({ projects, dependencies }: GanttChartProps) {
  ...
  return (
    <Card className="p-6 space-y-4">
      ...
      <div className="border rounded-lg overflow-x-auto scrollbar-thin scrollbar-thumb-accent">
            ...
            {projects.length === 0 ? (
              ...
              projects.map((project) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-48 p-3 border-r shrink-0 cursor-pointer hover:bg-accent/40 transition-colors bg-background/50"
                    ...
                    <div className="flex-1 p-3 min-h-[56px] relative">
                      {/* Today indicator */}
                      {showToday && (
                        <div
