...
export async function GET() {
  ...
  // In demo mode or for global admin, return mock chart data
    ...
    return NextResponse.json({
      ...
      data: {
        projectStatus: [
          ...
          { status: "Paused", _count: 3 },
          { status: "In Progress", _count: 12 },
        ],
        projectHealth: [
          { name: "Project Alpha", health: 85, progress: 90 },
          { name: "Project Beta", health: 70, progress: 65 },
          { name: "Project Gamma", health: 40, progress: 20 },
          { name: "Project Delta", health: 95, progress: 85 },
          { name: "Epsilon Web", health: 60, progress: 55 },
          { name: "Zeta App", health: 10, progress: 5 },
        ],
        taskPriority: [
          { priority: "high", _count: 15 },
          { priority: "medium", _count: 28 },
          { priority: "low", _count: 42 },
        ],
        teamMetrics: { activeMembers: 12, utilization: 78 },
        completionTrend: [
          { date: "Mon", completed: 5, pending: 8, overdue: 2 },
          { date: "Tue", completed: 12, pending: 6, overdue: 1 },
          { date: "Wed", completed: 8, pending: 10, overdue: 3 },
          { date: "Thu", completed: 15, pending: 4, overdue: 0 },
          { date: "Fri", completed: 10, pending: 12, overdue: 2 },
          { date: "Sat", completed: 3, pending: 2, overdue: 0 },
          { date: "Sun", completed: 2, pending: 1, overdue: 0 },
        ],
        teamProductivity: [
          { week: "Wk 12/1", Admin: 12, Alice: 8, Bob: 10, Charlie: 7 },
          { week: "Wk 12/8", Admin: 15, Alice: 10, Bob: 12, Charlie: 9 },
          { week: "Wk 12/15", Admin: 10, Alice: 15, Bob: 8, Charlie: 12 },
          { week: "Wk 12/22", Admin: 18, Alice: 12, Bob: 15, Charlie: 10 },
          { week: "Wk 12/29", Admin: 20, Alice: 18, Bob: 12, Charlie: 15 },
          { week: "Wk 1/5", Admin: 25, Alice: 20, Bob: 18, Charlie: 22 },
        ],
      },
      source: "mock",
    });
