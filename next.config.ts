    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.zegocloud.com https://*.zego.im",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: https: blob: https://*.zegocloud.com https://*.zego.im",
              "font-src 'self' data:",
              "connect-src 'self' data: https://firebasestorage.googleapis.com https://*.googleapis.com https://*.zegocloud.com wss://*.zegocloud.com https://*.zego.im wss://*.zego.im",
